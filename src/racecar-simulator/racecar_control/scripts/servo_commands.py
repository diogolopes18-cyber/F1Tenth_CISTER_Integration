...
#CAR3
#######################
def set_car3_control(data):

    pub_vel_left_rear_wheel_car3 = rospy.Publisher('/car3/left_rear_wheel_velocity_controller_car2/command', Float64, queue_size=1)
    pub_vel_right_rear_wheel_car3 = rospy.Publisher('/car3/right_rear_wheel_velocity_controller_car2/command', Float64, queue_size=1)
    pub_vel_left_front_wheel_car3 = rospy.Publisher('/car3/left_front_wheel_velocity_controller_car2/command', Float64, queue_size=1)
    pub_vel_right_front_wheel_car3 = rospy.Publisher('/car3/right_front_wheel_velocity_controller_car2/command', Float64, queue_size=1)

    pub_pos_left_steering_hinge_car3 = rospy.Publisher('/car3/left_steering_hinge_position_controller_car2/command', Float64, queue_size=1)
    pub_pos_right_steering_hinge_car3 = rospy.Publisher('/car3/right_steering_hinge_position_controller_car2/command', Float64, queue_size=1)


    throttle_car3 = data.drive.speed/0.1
    steer_car3 = data.drive.steering_angle

    pub_vel_left_rear_wheel_car3.publish(throttle_car3)
    pub_vel_right_rear_wheel_car3.publish(throttle_car3)
    pub_vel_left_front_wheel_car3.publish(throttle_car3)
    pub_vel_right_front_wheel_car3.publish(throttle_car3)
    pub_pos_left_steering_hinge_car3.publish(steer_car3)
    pub_pos_right_steering_hinge_car3.publish(steer_car3)
