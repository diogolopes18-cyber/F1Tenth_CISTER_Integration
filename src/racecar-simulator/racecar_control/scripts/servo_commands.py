...
def set_car1_control(data):
    ...
    pub_vel_left_rear_wheel_car1 = rospy.Publisher('/car1/left_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_right_rear_wheel_car1 = rospy.Publisher('/car1/right_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_left_front_wheel_car1 = rospy.Publisher('/car1/left_front_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_right_front_wheel_car1 = rospy.Publisher('/car1/right_front_wheel_velocity_controller/command', Float64, queue_size=1)

    pub_pos_left_steering_hinge_car1 = rospy.Publisher('/car1/left_steering_hinge_position_controller/command', Float64, queue_size=1)
    pub_pos_right_steering_hinge_car1 = rospy.Publisher('/car1/right_steering_hinge_position_controller/command', Float64, queue_size=1)
...
def set_car2_control(data):
    ...
    pub_vel_left_rear_wheel_car2 = rospy.Publisher('/car2/left_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_right_rear_wheel_car2 = rospy.Publisher('/car2/right_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_left_front_wheel_car2 = rospy.Publisher('/car2/left_front_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_right_front_wheel_car2 = rospy.Publisher('/car2/right_front_wheel_velocity_controller/command', Float64, queue_size=1)

    pub_pos_left_steering_hinge_car2 = rospy.Publisher('/car2/left_steering_hinge_position_controller/command', Float64, queue_size=1)
    pub_pos_right_steering_hinge_car2 = rospy.Publisher('/car2/right_steering_hinge_position_controller/command', Float64, queue_size=1)
