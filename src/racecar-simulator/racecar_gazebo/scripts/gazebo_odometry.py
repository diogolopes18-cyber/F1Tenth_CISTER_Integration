...
class OdometryNode:
    ...
    def __init__(self,racecar_name):
        ...
        #Publishes odometry for each car
        self.pub_odom = rospy.Publisher('/'+self.racecar_name+'/odom', Odometry, queue_size=1)
    ...
    def sub_robot_pose_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index(self.racecar_name+'::base_link')
